...
import { dashboardIcon } from '@cds/core/icon/shapes/dashboard';
import { dollarIcon } from '@cds/core/icon/shapes/dollar';
import { eyeIcon } from '@cds/core/icon/shapes/eye';
import { eyeHideIcon } from '@cds/core/icon/shapes/eye-hide';
import { fileIcon } from '@cds/core/icon/shapes/file';
import { helpInfoIcon } from '@cds/core/icon/shapes/help-info';
import { lineChartIcon } from '@cds/core/icon/shapes/line-chart';
